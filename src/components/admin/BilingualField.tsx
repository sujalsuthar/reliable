...
export default function BilingualField({
  ...
  const translate = async (direction: 'en-ar' | 'ar-en') => {
    ...
    try {
      ...
      if (direction === 'en-ar') onArChange(data.translated)
      else onEnChange(data.translated)
    } catch (error) {
      console.error(error)
  ...
  return (
    <div className={clsx('space-y-4 rounded-xl border border-gray-100 bg-gray-50/50 p-4', className)}>
